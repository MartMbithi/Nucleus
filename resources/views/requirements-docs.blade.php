  ...
  <body>
    ...
    <div class="page-title d-flex bg-dark" aria-label="Page title" style="background-image: url(img/pages/help-hero-bg.jpg);">
      <div class="container text-left align-self-center">
        <h1 class="page-title-heading text-white">Nucleus ERP System Requirements</h1>
      </div>
    </div>
    <!-- Page Content-->
    <!-- Main Container-->
          ...
          <div class="accordion" id="accordion" role="tablist">
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a href="#collapseOne" data-toggle="collapse">Environment</a></h6>
              </div>
              <div class="collapse show" id="collapseOne" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                    <li>PHP 5.6.4 or higher</li>
                    <li>Database (eg: MySQL, PostgreSQL, SQLite, SQL Server)</li>
                    <li>Web Server (eg: Apache, Nginx, Xampp IIS)</li>
                    <li>URL Rewrite (mod_rewrite)</li>
            ...
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a class="collapsed" href="#collapseTwo" data-toggle="collapse">PHP Extensions</a></h6>
              </div>

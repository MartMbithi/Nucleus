  ...
  <body>
    ...
    <div class="offcanvas-container is-triggered offcanvas-container-reverse" id="mobile-menu"><span class="offcanvas-close"><i class="fe-icon-x"></i></span>
      ...
      <div class="offcanvas-scrollable-area border-top" style="height:calc(100% - 235px); top: 144px;">
        ...
        <div class="accordion mobile-menu" id="accordion-menu">
          ...
          <!-- Portfolio-->
          <div class="card">
            <div class="card-header"><a class="mobile-menu-link " href="nucleus-erp-features.php">Features</a><a class="collapsed" href="#portfolio-submenu" data-toggle="collapse"></a></div>
            ...
            <div class="collapse" id="blog-submenu" data-parent="#accordion-menu">
              <div class="card-body">
                <ul>
                  ...
                  <li class="dropdown-item active"><a href="nucleus-erp-docs.php">Nucleus ERP fAQs</a></li>
      ...
      <div class="d-table-cell w-100 align-middle pl-md-3">
        ...
        <div class="navbar justify-content-end justify-content-lg-between">
          ...
          <ul class="navbar-nav d-none d-lg-block">
            ...
            <!-- Features-->
            <li class="nav-item dropdown-toggle "><a class="nav-link" href="nucleus-erp-features.php">Features</a>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="column">
                      <div class="widget widget-custom-menu">
                        ...
                        <ul>
                          <li class="active"><a href="nucleus-erp-faqs.php">Nucleus ERP FAQS</a></li>
    ...
    <section class="container pt-5 pb-4 mb-3">
      ...
      <div class="row pt-2">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-2"><a class="card" href="nucleus-erp-bill-no.php"><img class="d-block mx-auto mt-4" src="img/pages/help-icons/02.png" style="width: 80px;" alt="Managing Account">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-2"><a class="card" href="nucleus-erp-bills-payments.php"><img class="d-block mx-auto mt-4"   src="img/pages/help-icons/01.png" style="width: 80px;" alt="Working with Dashboard">
            <div class="card-body text-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-2"><a class="card" href="nucleus-erp-invoices.php"><img class="d-block mx-auto mt-4" src="img/pages/help-icons/03.png" style="width: 80px;" alt="Payment Methods">
            <div class="card-body text-center">

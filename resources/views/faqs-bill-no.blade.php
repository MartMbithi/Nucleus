  ...
  <body>
    ...
    <div class="page-title d-flex bg-dark" aria-label="Page title" style="background-image: url(img/pages/help-hero-bg.jpg);">
      <div class="container text-left align-self-center">
        <h1 class="page-title-heading text-white">Nucleus ERP Bills </h1>
      </div>
    </div>
    <!-- Page Content-->
    <!-- Main Container-->
          ...
          <div class="accordion" id="accordion" role="tablist">
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a href="#collapseOne" data-toggle="collapse">Why isn't the bill number auto generated?</a></h6>
              </div>
              <div class="collapse show" id="collapseOne" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                <p>  Bill is an invoice created by your vendor and you record it in NucleusERP to track the payment due to your vendor. This means all the information you use to record the bill, including the reference or bill number, is taken from the invoice they send you and it's number can't be auto generated.</p>
                </div>
              </div>
            </div>
            <!--

  ...
  <body>
                  ...
                  <div class="d-flex">
                    <div class="column">
                      <div class="widget widget-custom-menu">
                        ...
                        <ul>
                          <li class=""><a href="{{ url('/nucleus-erp-docs') }}">Nucleus ERP Docs</a></li>
                    ...
                    <div class="column">
                      <div class="widget widget-custom-menu">
                        <h4 class=" active widget-title">FAQs</h4>
                        <ul>
                          <li class = "active"><a href="{{ url('/nucleus-erp-faqs') }}">Nucleus ERP FAQS</a></li>
    ...
    <div class="page-title d-flex bg-dark" aria-label="Page title" style="background-image: url(img/pages/help-hero-bg.jpg);">
      <div class="container text-left align-self-center">
        <h1 class="page-title-heading text-white">Nucleus ERP Bills And Payments </h1>
      </div>
    </div>
    <!-- Page Content-->
    <!-- Main Container-->
          ...
          <div class="accordion" id="accordion" role="tablist">
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a href="#collapseOne" data-toggle="collapse">Bills</a></h6>
              </div>
              <div class="collapse show" id="collapseOne" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                  <p> Bill is a document received from your vendor that indicates the items (product or service) bought by you. It is generally not paid yet. You should use bills if you work with tax. </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a class="collapsed" href="#collapseTwo" data-toggle="collapse">Payments</a></h6>
              </div>
              <div class="collapse" id="collapseTwo" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                <p> Payment is a non-billable and paid expense. For example, food that you eat while on business trips. There are no items within the payments. Tax is not applicable. Do not confuse this with payments added to a bill/invoice.</p>
                </div>
              </div>
            </div>       

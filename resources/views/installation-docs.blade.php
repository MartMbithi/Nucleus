  ...
  <body>
    ...
    <div class="page-title d-flex bg-dark" aria-label="Page title" style="background-image: url(img/pages/help-hero-bg.jpg);">
      <div class="container text-left align-self-center">
        <h1 class="page-title-heading text-white">Nucleus ERP System Installation </h1>
      </div>
    </div>
    <!-- Page Content-->
    <!-- Main Container-->
          ...
          <div class="accordion" id="accordion" role="tablist">
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a href="#collapseOne" data-toggle="collapse">Installation</a></h6>
              </div>
              <div class="collapse show" id="collapseOne" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                    <p> This guide will show you how to install Nucleus ERP in your local or remote server just in a couple of minutes.</p>
                </div>
              </div>
            </div>
            <div class="card">
              <div class="card-header" role="tab">
                <h6><a class="collapsed" href="#collapseTwo" data-toggle="collapse">Steps</a></h6>
              </div>
              <div class="collapse" id="collapseTwo" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                <li>Download package.</li>
                <li>Unzip it in your localserver directory (in XAMPP, LAMPP) htdocs/ </li>
                <li>Upload all the files to your remote server under public_html directory </li>
                <li>Launch the Installer by typing http://your_dorman_address/nucleuserp example( http://127.0.0.1/nucleuserp/)</li>
                <li>This Launches Installation wizard that prompts you to select language</li>
                <li>After Selecting language, Configure your connection properties ie: (database username and password)</li>
                <li>The following wizard allows you to create a currencies, tax, companies and then API token.</li>
                <li>If all these steps are executed it will install the system in your local or remote server.</li>
                <li>Now that installation is complete, you can log into the admin panel.</li>
